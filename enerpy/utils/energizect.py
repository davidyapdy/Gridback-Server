...
def get_prices():
    ...
    for company in raw_companies:
        ...
        keys = [
            ...
            ["type", "billing_cycle", "cancellation_fee", "enrollment_fee"],
            ["percentage", "quality"],
        ]
        ...
        for col, td in enumerate(row_cells):
            ...
            if col == 0:
                ...
                data['cycle'] = row_data[1]
                data['cancellation'] = row_data[2]
                data['enrollment'] = row_data[3]
            elif col == 2:
                data['renewable'] = list(filter(lambda x: x.isdigit(), row_data[0]))[0]
            elif col == 3:
                data['supply_rate'] = row_data[0]
